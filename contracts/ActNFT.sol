    ...
    Ownable
{
    ...
    constructor() ERC721("ACT NOW", "ACT") {
        whitelistedAddresses[msg.sender] = true;
    }

    function safeMint(uint96 _royaltyFeeArtist, string memory _tokenURI)
        public
        onlyWhitelisted
    {
        require(
            _royaltyFeeArtist <= uint96(5000),
            "can not over 50% for royalty"
        );
